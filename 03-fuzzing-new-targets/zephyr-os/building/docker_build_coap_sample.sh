...
export SAMPLE_DIR=samples/net/sockets/coap_server
export PATCHES="${PATCHES:-} ieee802154_rf2xx_size_check.patch wdt_sam_watchdog_callback_check.patch coap-802154.patch 802154-mpu.patch"
